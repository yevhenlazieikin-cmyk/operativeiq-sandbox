...
@Component({
  ...
  imports: [Header, ActionButtonsPanel, Tabber, DetailsPanel, Footer, GridModule, ReactiveFormsModule],
...
export class CrewsStatisticsComponent implements AfterViewInit {
  ...
  protected onDataChange(data: CrewMember[]): void {
    this.displayedMembers.set(data);
  }
    ...
    this.service
      ...
      .subscribe(s => {
        this.summaryForm.patchValue({
          totalCrews: String(s.totalCrews),
          activeCrews: String(s.activeCrews),
          inactiveCrews: String(s.inactiveCrews),
          totalMembers: String(s.totalMembers),
